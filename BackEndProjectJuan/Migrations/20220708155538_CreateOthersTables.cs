    ...
    public partial class CreateOthersTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SocialAddresses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "ProductSocialAddresses",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProcuctId = table.Column<int>(nullable: false),
                    ProductId = table.Column<int>(nullable: true),
                    SocialAddressId = table.Column<int>(nullable: false),
                    Url = table.Column<string>(maxLength: 255, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductSocialAddresses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductSocialAddresses_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductSocialAddresses_SocialAddresses_SocialAddressId",
                        column: x => x.SocialAddressId,
                        principalTable: "SocialAddresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSocialAddresses_ProductId",
                table: "ProductSocialAddresses",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductSocialAddresses_SocialAddressId",
                table: "ProductSocialAddresses",
